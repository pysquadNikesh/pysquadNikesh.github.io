...
export const services = [
  {
    ...
    description:
      "Seamlessly deploy Odoo tailored to your business needs, ensuring a smooth transition and optimal performance.",
  },
  {
    image: "assets/images/Cuntomization.svg",
    title: "Customisation / Development",
    description:
      "Enhance Odoo functionalities with tailored modules and workflows to meet unique business requirements.",
  },
  {
    image: "assets/images/Migration.svg",
    title: "Migration / Integration",
    description:
      "Effortlessly migrate data to the latest Odoo version and integrate it with third-party applications for seamless operations.",
  },
  {
    image: "assets/images/Consultation.svg",
    title: "Consultation",
    description:
      "Expert guidance to strategize, plan, and maximize the efficiency of Odoo for your business success.",
  },
];
...
export const certificates = [
  {
    name: "Odoo 17 Functional Certificate",
    image: "assets/images/odoo_17_certification.png",
  },
];
